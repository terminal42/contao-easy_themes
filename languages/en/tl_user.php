 ...
 * Table tl_user
 */
$GLOBALS['TL_LANG']['tl_user']['et_enable'] = array('Enable EasyThemes', 'Enable EasyThemes for faster theme editing.');
$GLOBALS['TL_LANG']['tl_user']['et_mode'] = array('EasyThemes Mode', 'Decide whether you prefer to use EasyThemes with the contextmenu, the mousover, the direct DOM-Inject or the back end module mode.');
$GLOBALS['TL_LANG']['tl_user']['et_short'] = array('Enable short view', 'Enable the short view for EasyThemes.');
